...
## [5.0.1](https://github.com/zthun/bouncer/compare/v5.0.0...v5.0.1) (2026-08-26)

### Bug Fixes

- add the shebang to run main ([c9b48f7](https://github.com/zthun/bouncer/commit/c9b48f7e7c85a268ec28037d48587cf7244440c8))
...
- chore: update yarn lockfile [skip ci] ([9a3f024](https://github.com/zthun/bouncer/commit/9a3f024))
...
- bouncer config now requires full url paths
...
- bouncer config now requires full url paths ([72595b6](https://github.com/zthun/bouncer/commit/72595b6f1c5b3e3165c90e5d20ad3858aee8468c))
